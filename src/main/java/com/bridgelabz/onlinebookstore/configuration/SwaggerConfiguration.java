...
public class SwaggerConfiguration {
    ...
    public Docket apiDocket() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(getApiInfo()).select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.onlinebookstore")).paths(PathSelectors.any()).build();
    }

    private ApiInfo getApiInfo() {

        Contact contact = new Contact("CFP-051", "https://bridgelabz.com/", "mounamc267@gmail.com");
